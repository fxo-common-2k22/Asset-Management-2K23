using FAPP.Models;
using FAPP.ViewModel.Common.HRPayroll;
using FAPP.ViewModel.Common.IB;
using FAPP.ViewModel.Common.POS;
...
namespace FAPP.ViewModel.Common
{
    public partial class GraphsModel
    {
        ...
        public MonthWiseVoucherStatsModel MonthWiseVoucherStatsList { get; set; }
        ...
        public List<AvailableTeachers> AvailableTeachers { get; set; }
