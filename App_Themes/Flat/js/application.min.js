...
$(document).ready(function () {
	   ...
	   $("#left").resizable({
		  ...
		  stop: function () {
			 ...
			 if (typeof (Storage) !== "undefined") {
				// Store
				localStorage.setItem("LeftWidth", $("#left").width());
			 }
    ...
    function setNewWidth()
    {
	   if (typeof (Storage) !== "undefined") {
		  // Store
		  var uiwidth = localStorage.getItem("LeftWidth");
    ...
    $(".theme-colors > li > span").hover(function (e) {
	   ...
	   $.get('/Home/SaveTheme', { "theme": "theme-" + $el.attr("class") }, function () {
	       // Check browser support
	       if (typeof (Storage) !== "undefined") {
	           // Store
	           localStorage.setItem("ThemeColor", "theme-" + $el.attr("class"));
	       }
	   });
    });
